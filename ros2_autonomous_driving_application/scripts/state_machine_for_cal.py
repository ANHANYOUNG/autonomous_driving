...
class StateMachineExecutor(Node):
    def __init__(self):
        ...
        # 사람 감지 토픽 구독
        self.create_subscription(Bool, '/person/detected', self.person_detected_callback, 10)
